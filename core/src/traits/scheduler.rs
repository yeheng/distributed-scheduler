...
pub trait StateListenerService: Send + Sync {
    ...
    /// 处理状态更新
    async fn process_status_update(&self, task_run_id: i64, status: crate::models::TaskRunStatus, result: Option<String>, error_message: Option<String>) -> Result<()>;
}
...
pub trait WorkerService: Send + Sync {
    ...
    /// 发送状态更新
    async fn send_status_update(&self, task_run_id: i64, status: crate::models::TaskRunStatus, result: Option<String>, error_message: Option<String>) -> Result<()>;
