...
async fn test_login_with_valid_credentials() {
    ...
    let task_controller = std::sync::Arc::new(MockTaskController) as std::sync::Arc<dyn scheduler_foundation::traits::TaskControlService>;
...
impl scheduler_domain::repositories::TaskRepository for MockTaskRepository {
    ...
    async fn get_by_id(&self, _id: i64) -> scheduler_foundation::SchedulerResult<Option<scheduler_domain::entities::Task>> {
        unimplemented!()
    }
...
impl scheduler_domain::repositories::TaskRunRepository for MockTaskRunRepository {
    ...
    async fn get_execution_stats(&self, _task_id: i64, _days: i32) -> scheduler_foundation::SchedulerResult<TaskExecutionStats> {
        unimplemented!()
    }
...
impl scheduler_domain::repositories::WorkerRepository for MockWorkerRepository {
    ...
    async fn get_worker_load_stats(&self) -> scheduler_foundation::SchedulerResult<Vec<WorkerLoadStats>> {
        unimplemented!()
    }
