...
impl scheduler_domain::repositories::TaskRepository for MockTaskRepository {
    ...
    ) -> SchedulerResult<scheduler_domain::entities::Task> {
        unimplemented!()
    }
    ...
    async fn get_by_id(
        &self,
        _id: i64,
    ) -> SchedulerResult<Option<scheduler_domain::entities::Task>> {
        unimplemented!()
    }
...
impl scheduler_domain::repositories::TaskRunRepository for MockTaskRunRepository {
    ...
    ) -> SchedulerResult<scheduler_domain::entities::TaskRun> {
        unimplemented!()
    }
    ...
    async fn get_by_id(
        &self,
        _id: i64,
    ) -> SchedulerResult<Option<scheduler_domain::entities::TaskRun>> {
        unimplemented!()
    }
...
impl scheduler_domain::repositories::WorkerRepository for MockWorkerRepository {
    ...
    async fn get_by_id(
        &self,
        _worker_id: &str,
    ) -> SchedulerResult<Option<scheduler_domain::entities::WorkerInfo>> {
        unimplemented!()
    }
