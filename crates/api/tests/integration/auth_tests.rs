...
use scheduler_api::{
    auth::{AuthConfig, AuthType, AuthenticatedUser, Permission},
    create_simple_app,
};
...
async fn test_login_with_valid_credentials() {
    let task_repo = std::sync::Arc::new(MockTaskRepository)
        as std::sync::Arc<dyn scheduler_domain::repositories::TaskRepository>;
    let task_run_repo = std::sync::Arc::new(MockTaskRunRepository)
    ...
    let task_controller = std::sync::Arc::new(MockTaskController)
        as std::sync::Arc<dyn scheduler_foundation::traits::TaskControlService>;
...
async fn test_jwt_token_validation() {
    ...
    let jwt_service = scheduler_api::auth::JwtService::new(
...
impl scheduler_domain::repositories::TaskRepository for MockTaskRepository {
    ...
    ) -> scheduler_foundation::SchedulerResult<scheduler_domain::entities::Task> {
        unimplemented!()
    }
    ...
    async fn get_by_id(
        &self,
        _id: i64,
    ) -> scheduler_foundation::SchedulerResult<Option<scheduler_domain::entities::Task>> {
        unimplemented!()
    }
    ...
    async fn update(
        &self,
        _task: &scheduler_domain::entities::Task,
    ) -> scheduler_foundation::SchedulerResult<()> {
        unimplemented!()
    }
    ...
    ) -> scheduler_foundation::SchedulerResult<Vec<scheduler_domain::entities::Task>> {
        Ok(vec![])
    }
...
impl scheduler_domain::repositories::TaskRunRepository for MockTaskRunRepository {
    ...
    async fn get_by_id(
        &self,
        _id: i64,
    ) -> scheduler_foundation::SchedulerResult<Option<scheduler_domain::entities::TaskRun>> {
        unimplemented!()
    }
    ...
    async fn get_execution_stats(
        ...
        _task_id: i64,
        _days: i32,
    ) -> scheduler_foundation::SchedulerResult<TaskExecutionStats> {
        unimplemented!()
    }
...
impl scheduler_domain::repositories::WorkerRepository for MockWorkerRepository {
    ...
    async fn get_by_id(
        &self,
        _worker_id: &str,
    ) -> scheduler_foundation::SchedulerResult<Option<scheduler_domain::entities::WorkerInfo>> {
        unimplemented!()
    }
    ...
    async fn list(
        &self,
    ) -> scheduler_foundation::SchedulerResult<Vec<scheduler_domain::entities::WorkerInfo>> {
        Ok(vec![])
    }
    ...
    async fn cleanup_offline_workers(
        &self,
        _timeout_seconds: i64,
    ) -> scheduler_foundation::SchedulerResult<u64> {
        unimplemented!()
    }

    async fn get_worker_load_stats(
        &self,
    ) -> scheduler_foundation::SchedulerResult<Vec<WorkerLoadStats>> {
        unimplemented!()
    }
